...
rostopic pub --once /asc/planner/curr_pose geometry_msgs/Pose '{position:  {x: 1.0, y: 1.0, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}'
...
rostopic pub --once /asc/planner/curr_pose geometry_msgs/Pose '{position:  {x: 1.2, y: 0.75, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}'
prompt "Try again, ensure nothing is published"

# simulating the robot moving to (x,y) = (1.3, 0.5)
rostopic pub --once /asc/planner/curr_pose geometry_msgs/Pose '{position:  {x: 1.3, y: 0.5, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}'
